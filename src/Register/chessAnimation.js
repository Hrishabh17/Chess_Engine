...
export default function ChessAnimation() {
    ...
    return (
        <div className='flex flex-col items-center justify-between h-full w-full sm:px-0 md:px-4 absolute z-0'>
            {
                Array(45).fill().map((_, i)=>(

                    <div key={i} className='flex flex-row items-center justify-between w-full h-max md:px-4'>
                    {
